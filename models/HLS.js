...
var debug = require('debug')('snowstreams:model:HLS');
...
HLS.schema.pre('save', function(go) {
	var doc = this;
...
HLS.schema.statics.addCodec = function addCodec(doc, finished) {
...
HLS.defaultColumns = 'name, ext|20%, source|20%, codec';

HLS.relationship({ ref: 'Channel', path: 'hls' });
