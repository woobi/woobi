...
module.exports = function(app, Broadcast, opts, cb) {
	//SystemJS.import('gblconfig.js')
	//.then(SystemJS.import('app/routes.js').then(function(m) {
		//Routes = m.default;
		//StaticRoutes = m.staticConfig;
		debug("####   App Routes Loaded... Finishing Express Routes   ####");
		...
		app.get('*', function(req, res) {
			res.status(200).send(render( '', '', false, Broadcast));	
		});
