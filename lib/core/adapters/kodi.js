 ...
 * @api public
 */
	var Kodi = function (opts, callback) {
		if (!(this instanceof Kodi)) return new Kodi(opts, callback);
		debug('Kodi Adapter construtor');
		var _this = this;
		this.connection;
		...
		debug('Kodi Adapter return', this.connection);
		return this;
	}
	
	/** images **/
	Kodi.prototype.grabMedia = function(id, type) {
		if(!type) {
			type = 'tvshow';
		}
	...
	/** custom sql **/
	Kodi.prototype.query = function(sql) {
	...
	/** recent tv episodes **/
	Kodi.prototype.recentEpisodes = function(num = 100) {
		debug(num)	
	...
	/** tv shows **/
	Kodi.prototype.tvShows = function(all) {
	...
	/** tv show **/
	Kodi.prototype.tvShow = function(ID) {
	...
	/** tv shows **/
	Kodi.prototype.tvShowByName = function(ID) {
	...
	/** tv shows **/
	Kodi.prototype.tvShowByIMDB = function(IMDB) {
	...
	/** show episodes **/
	Kodi.prototype.tvShowEpisodes = function(showID) {
	...
	/** recent movies **/
	Kodi.prototype.recentMovies = function(num) {
		if ( !Number(num) ) {
			num = 50
		}
	...
	/** movies **/
	Kodi.prototype.movies = function() {
	...
	Kodi.prototype.movieByName = function(name) {
	...
	Kodi.prototype.movie = function(ID) {
	...
	Kodi.prototype.movieByIMDB = function(IMDB) {
