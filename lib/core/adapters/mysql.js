...
module.exports = function(Broadcast) {
	...
	/** recent tv episodes **/
	Mysql.prototype.grabMedia = function(id) {
		return this.connection.query("select * from art where media_id='" + id + "'")
			.then(function(rows){
				return rows;
			})
			.catch(console.log);
	...
	Mysql.prototype.movieByName = function(name) {
		...
		return this.connection.query(sql)
			.then((rows) => {
				...
				return this.grabMedia(ep.idMovie)
				.then(art => {
						all.art = art;
						return all;
				});
