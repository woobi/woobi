...
/** getGuideProgram **/
Adapter.prototype.getGuideProgram = function ( searchFor, searchKey ) {
	if ( _.isFunction( this.adapter.getGuideProgram ) ) {
		return this.adapter.getGuideProgram( searchFor, searchKey );
	} else {
		console.log( 'getGuideProgram adapter function is missing!' );
		return false;
	}
}
...
/** setTimer **/
Adapter.prototype.setTimer = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.setTimer ) ) {
		return this.adapter.setTimer( obj );
	} else {
		console.log( 'setTimer adapter function is missing!' );
		return false;
	}
}

/** deleteTimer **/
Adapter.prototype.deleteTimer = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.deleteTimer ) ) {
		return this.adapter.deleteTimer( obj );
	} else {
		console.log( 'deleteTimer adapter function is missing!' );
		return false;
	}
}

/** deleteSeriesTimer **/
Adapter.prototype.deleteSeriesTimer = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.deleteSeriesTimer ) ) {
		return this.adapter.deleteSeriesTimer( obj );
	} else {
		console.log( 'deleteSeriesTimer adapter function is missing!' );
		return false;
	}
}

/** getRecordings **/
Adapter.prototype.getRecordings = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.getRecordings ) ) {
		return this.adapter.getRecordings( obj );
	} else {
		console.log( 'getRecordings adapter function is missing!' );
		return false;
	}
}

/** deleteRecording **/
Adapter.prototype.deleteRecording = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.deleteRecording ) ) {
		return this.adapter.deleteRecording( obj );
	} else {
		console.log( 'deleteRecording adapter function is missing!' );
		return false;
	}
}

/** openTuner **/
Adapter.prototype.openTuner = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.openTuner ) ) {
		return this.adapter.openTuner( obj );
	} else {
		console.log( 'openTuner adapter function is missing!' );
		return false;
	}
}
...
/** recent tv episodes **/
Adapter.prototype.recentEpisodes = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.recentEpisodes ) ) {
		return this.adapter.recentEpisodes( obj );
	} else {
...
/** recent movies **/
Adapter.prototype.recentMovies = function ( obj = {} ) {
	if ( _.isFunction( this.adapter.recentMovies ) ) {
		return this.adapter.recentMovies( obj );
	} else {
