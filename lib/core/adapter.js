...
/* Start Local Media */
/** generic media files **/
Adapter.prototype.mediaFiles = function ( num = 25 ) {
	if ( _.isFunction( this.adapter.mediaFiles ) ) {
		return this.adapter.mediaFiles( num );
	} else {
...
/** generic media file **/
Adapter.prototype.mediaFile = function ( num = 25 ) {
	if ( _.isFunction( this.adapter.mediaFile ) ) {
		return this.adapter.mediaFile( num );
	} else {
