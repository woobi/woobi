...
var debug = require('debug')('woobi:stream:udp');
	...
	return function UDP(opts, callback) {
		...
		function createUDP(options) {
			...
			if(options.multicast) {
				...
				_this.udp.setMulticastTTL(options.multicastTTL || 2);
				_this.udp.addMembership(options.host); 
			}
